...
export default css`
  ...
  .drawer__header-actions mf-icon-button,
  .drawer__header-actions ::slotted(mf-icon-button) {
    flex: 0 0 auto;
    display: flex;
    align-items: center;
  ...
  .drawer__footer ::slotted(mf-button:not(:last-of-type)) {
