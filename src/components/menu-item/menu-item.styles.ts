...
export default css`
  ...
  .menu-item {
    ...
    padding: var(--mf-spacing-2x-small) var(--mf-spacing-2x-small);
  ...
  .menu-item.menu-item--loading *:not(mf-spinner) {
    opacity: 0.5;
  }

  .menu-item--loading mf-spinner {
  ...
  .menu-item--submenu-expanded::after {
    content: '';
    position: fixed;
    z-index: calc(var(--mf-z-index-dropdown) - 1);
    top: 0;
    right: 0;
    bottom: 0;
    left: 0;
  ...
  .menu-item--rtl mf-popup::part(popup) {
