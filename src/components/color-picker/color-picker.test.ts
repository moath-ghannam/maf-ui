...
import type MfColorPicker from './color-picker.js';

describe('<mf-color-picker>', () => {
  describe('when the value changes', () => {
    it('should not emit mf-change or mf-input when the value is changed programmatically', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker></mf-color-picker> `);
      const color = 'rgb(255, 204, 0)';

      el.addEventListener('mf-change', () => expect.fail('mf-change should not be emitted'));
      el.addEventListener('mf-input', () => expect.fail('mf-change should not be emitted'));
      el.value = color;
      await el.updateComplete;
    });

    it('should emit mf-change and mf-input when the color grid selector is moved', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker></mf-color-picker> `);
      ...
      // Simulate a drag event. "mf-change" should not fire until we stop dragging.
    ...
    it('should emit mf-change and mf-input when the hue slider is moved', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker></mf-color-picker> `);
      const trigger = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="trigger"]')!;
    ...
    it('should emit mf-change and mf-input when the opacity slider is moved', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker opacity></mf-color-picker> `);
      const trigger = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="trigger"]')!;
    ...
    it('should emit mf-change and mf-input when toggling the format', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker value="#fff"></mf-color-picker> `);
      const trigger = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="trigger"]')!;
    ...
    it('should render the correct swatches when passing a string of color values', async () => {
      const el = await fixture<MfColorPicker>(html`
        <mf-color-picker swatches="red; #008000; rgb(0,0,255);"></mf-color-picker>
      `);
    ...
    it('should emit mf-change and mf-input when clicking on a swatch', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker swatches="red; green; blue;"></mf-color-picker> `);
      const trigger = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="trigger"]')!;
    ...
    it('should emit mf-change and mf-input when selecting a color with the keyboard', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker></mf-color-picker> `);
      const trigger = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="trigger"]')!;
    ...
    it('should emit mf-change and mf-input when selecting hue with the keyboard', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker></mf-color-picker> `);
      const trigger = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="trigger"]')!;
    ...
    it('should emit mf-change and mf-input when selecting opacity with the keyboard', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker opacity></mf-color-picker> `);
      const trigger = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="trigger"]')!;
    ...
    it('should emit mf-change and mf-input when entering a value in the color input and pressing enter', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker opacity></mf-color-picker> `);
      const trigger = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="trigger"]')!;
    ...
    it('should emit mf-change and mf-input when entering a value in the color input and blurring the field', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker opacity></mf-color-picker> `);
      const trigger = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="trigger"]')!;
      const input = el.shadowRoot!.querySelector<HTMLElement>('[part~="input"]')!;
      const changeHandler = sinon.spy();
    ...
    it('should render the correct format when selecting a swatch of a different format', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker format="rgb"></mf-color-picker> `);
      const trigger = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="trigger"]')!;
      const changeHandler = sinon.spy();
      const inputHandler = sinon.spy();
  ...
  it('should render in a dropdown', async () => {
    const el = await fixture<MfColorPicker>(html` <mf-color-picker></mf-color-picker> `);
    const dropdown = el.shadowRoot!.querySelector('mf-dropdown');

    expect(dropdown).to.exist;
  });

  it('should not render in a dropdown when inline is enabled', async () => {
    const el = await fixture<MfColorPicker>(html` <mf-color-picker inline></mf-color-picker> `);
    const dropdown = el.shadowRoot!.querySelector('mf-dropdown');
  ...
  it('should show opacity slider when opacity is enabled', async () => {
    const el = await fixture<MfColorPicker>(html` <mf-color-picker opacity></mf-color-picker> `);
    const opacityMfider = el.shadowRoot!.querySelector('[part*="opacity-slider"]')!;

    expect(opacityMfider).to.exist;
  });

  it('should display a color when an initial value is provided', async () => {
    const el = await fixture<MfColorPicker>(html` <mf-color-picker value="#000"></mf-color-picker> `);
    const trigger = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="trigger"]');
  ...
  it('should display a color with opacity when an initial value with opacity is provided', async () => {
    const el = await fixture<MfColorPicker>(html` <mf-color-picker opacity value="#ff000050"></mf-color-picker> `);
    const trigger = el.shadowRoot!.querySelector<HTMLButtonElement>('[part~="trigger"]')!;
  ...
  it.skip('should emit mf-focus when rendered as a dropdown and focused', async () => {
    const el = await fixture<MfColorPicker>(html`
      <div>
    ...
    `);
    const colorPicker = el.querySelector('mf-color-picker')!;
    const trigger = colorPicker.shadowRoot!.querySelector<HTMLButtonElement>('[part~="trigger"]')!;
    const button = el.querySelector('button')!;
    const focusHandler = sinon.spy();
    const blurHandler = sinon.spy();

    colorPicker.addEventListener('mf-focus', focusHandler);
    colorPicker.addEventListener('mf-blur', blurHandler);
  ...
  it('should emit mf-focus when rendered inline and focused', async () => {
    const el = await fixture<MfColorPicker>(html`
      <div>
        <mf-color-picker inline></mf-color-picker>
        <button type="button">Click me</button>
      </div>
    `);
    const colorPicker = el.querySelector('mf-color-picker')!;
  ...
  it('should focus and blur when calling focus() and blur() and rendered as a dropdown', async () => {
    const colorPicker = await fixture<MfColorPicker>(html` <mf-color-picker></mf-color-picker> `);
    const focusHandler = sinon.spy();
    const blurHandler = sinon.spy();
  ...
  it('should focus and blur when calling focus() and blur() and rendered inline', async () => {
    const colorPicker = await fixture<MfColorPicker>(html` <mf-color-picker inline></mf-color-picker> `);
    const focusHandler = sinon.spy();
    const blurHandler = sinon.spy();
  ...
  describe('when submitting a form', () => {
    it('should serialize its name and value with FormData', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <mf-color-picker name="a" value="#ffcc00"></mf-color-picker>
        </form>
      `);
    ...
    it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <mf-color-picker form="f" name="a" value="#ffcc00"></mf-color-picker>
        </div>
      `);
  ...
  describe('when resetting a form', () => {
    it('should reset the element to its initial value', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <mf-color-picker name="a" value="#ffffff"></mf-color-picker>
          <mf-button type="reset">Reset</mf-button>
        </form>
      `);
      const button = form.querySelector('mf-button')!;
      const colorPicker = form.querySelector('mf-color-picker')!;
  ...
  describe('when using constraint validation', () => {
    ...
    it('should be invalid when required and empty', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker required></mf-color-picker> `);
      expect(el.checkValidity()).to.be.false;
    });

    it('should be invalid when required and disabled is removed', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker disabled required></mf-color-picker> `);
      el.disabled = false;
      await el.updateComplete;
      expect(el.checkValidity()).to.be.false;
    });
    ...
    it('should receive the correct validation attributes ("states") when valid', async () => {
      const el = await fixture<MfColorPicker>(html` <mf-color-picker required value="#fff"></mf-color-picker> `);
  ...
  runFormControlBaseTests('mf-color-picker');
});
