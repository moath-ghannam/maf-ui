...
import type MfCarousel from './carousel.js';

describe('<mf-carousel>', () => {
  ...
  it('should render a carousel with default configuration', async () => {
    ...
    const el = await fixture(html`
      <mf-carousel>
        <mf-carousel-item>Node 1</mf-carousel-item>
        <mf-carousel-item>Node 2</mf-carousel-item>
        <mf-carousel-item>Node 3</mf-carousel-item>
      </mf-carousel>
    `);
  ...
  describe('when `autoplay` attribute is provided', () => {
    ...
    it('should scroll forwards every `autoplay-interval` milliseconds', async () => {
      // Arrange
      const el = await fixture<MfCarousel>(html`
        <mf-carousel autoplay autoplay-interval="10">
          <mf-carousel-item>Node 1</mf-carousel-item>
          <mf-carousel-item>Node 2</mf-carousel-item>
          <mf-carousel-item>Node 3</mf-carousel-item>
        </mf-carousel>
  ...
  describe('when `loop` attribute is provided', () => {
    ...
    describe('and `slides-per-page` is provided', () => {
      it('should create multiple clones', async () => {
        // Arrange
        const el = await fixture<MfCarousel>(html`
          <mf-carousel loop slides-per-page="2">
            <mf-carousel-item>Node 1</mf-carousel-item>
            <mf-carousel-item>Node 2</mf-carousel-item>
            <mf-carousel-item>Node 3</mf-carousel-item>
          </mf-carousel>
  ...
  describe('when `pagination` attribute is provided', () => {
    ...
    describe('and user clicks on a pagination button', () => {
      it('should scroll the carousel to the nth slide', async () => {
        ...
        expect(el.goToMfide).to.have.been.calledWith(2);
      });
    });
  });
      ...
      it(`should display ${expected} pages for ${slides} slides grouped by ${slidesPerPage} and scrolled by ${slidesPerMove}${
        ...
        const el = await fixture<MfCarousel>(html`
          <mf-carousel
            ...
            ?loop=${loop}
          >
            ${map(range(slides), i => html`<mf-carousel-item>${i}</mf-carousel-item>`)}
          </mf-carousel>
        `);
  ...
  describe('when `slides-per-move` attribute is provided', () => {
    it('should set the granularity of snapping', async () => {
      ...
      const el = await fixture<MfCarousel>(html`
        <mf-carousel slides-per-page="${expectedSnapGranularity}" slides-per-move="${expectedSnapGranularity}">
          <mf-carousel-item>Node 1</mf-carousel-item>
          <mf-carousel-item>Node 2</mf-carousel-item>
          <mf-carousel-item>Node 3</mf-carousel-item>
          <mf-carousel-item>Node 4</mf-carousel-item>
        </mf-carousel>
      `);
    ...
    it('should be possible to move by the given number of slides at a time', async () => {
      // Arrange
      const el = await fixture<MfCarousel>(html`
        <mf-carousel navigation slides-per-move="2" slides-per-page="2">
          <mf-carousel-item>Node 1</mf-carousel-item>
          <mf-carousel-item>Node 2</mf-carousel-item>
          <mf-carousel-item class="expected">Node 3</mf-carousel-item>
          <mf-carousel-item class="expected">Node 4</mf-carousel-item>
          <mf-carousel-item>Node 5</mf-carousel-item>
          <mf-carousel-item>Node 6</mf-carousel-item>
        </mf-carousel>
      `);
      const expectedMfides = el.querySelectorAll('.expected');
      ...
      // Assert
      for (const expectedMfide of expectedMfides) {
        expect(expectedMfide).to.have.class('--in-view');
        expect(expectedMfide).to.be.visible;
      }
    });
    ...
    it('should be possible to move by a number that is less than the displayed number', async () => {
      // Arrange
      const el = await fixture<MfCarousel>(html`
        <mf-carousel navigation slides-per-move="1" slides-per-page="2">
          <mf-carousel-item>Node 1</mf-carousel-item>
          <mf-carousel-item>Node 2</mf-carousel-item>
          <mf-carousel-item>Node 3</mf-carousel-item>
          <mf-carousel-item>Node 4</mf-carousel-item>
          <mf-carousel-item class="expected">Node 5</mf-carousel-item>
          <mf-carousel-item class="expected">Node 6</mf-carousel-item>
        </mf-carousel>
      `);
      const expectedMfides = el.querySelectorAll('.expected');
      const nextButton: HTMLElement = el.shadowRoot!.querySelector('.carousel__navigation-button--next')!;
    ...
    it('should not be possible to move by a number that is greater than the displayed number', async () => {
      // Arrange
      const expectedMfidesPerMove = 2;
      const el = await fixture<MfCarousel>(html`
        <mf-carousel slides-per-page="${expectedMfidesPerMove}">
          <mf-carousel-item>Node 1</mf-carousel-item>
          <mf-carousel-item>Node 2</mf-carousel-item>
          <mf-carousel-item>Node 3</mf-carousel-item>
          <mf-carousel-item>Node 4</mf-carousel-item>
      ...
      // Assert
      expect(el.slidesPerMove).to.be.equal(expectedMfidesPerMove);
    });
  });
  ...
  describe('when `orientation` attribute is provided', () => {
    describe('and value is `vertical`', () => {
      it('should make the scrollable along the y-axis', async () => {
        // Arrange
        const el = await fixture<MfCarousel>(html`
          <mf-carousel orientation="vertical" style="height: 100px">
            <mf-carousel-item>Node 1</mf-carousel-item>
            <mf-carousel-item>Node 2</mf-carousel-item>
          </mf-carousel>
        `);
    ...
    describe('and value is `horizontal`', () => {
      it('should make the scrollable along the x-axis', async () => {
        // Arrange
        const el = await fixture<MfCarousel>(html`
          <mf-carousel orientation="horizontal" style="height: 100px">
            <mf-carousel-item>Node 1</mf-carousel-item>
            <mf-carousel-item>Node 2</mf-carousel-item>
          </mf-carousel>
        `);
  ...
  describe('when `mouse-dragging` attribute is provided', () => {
    ...
    it.skip('should be possible to drag the carousel using the mouse', async () => {
      ...
      // Assert
      expect(el.activeMfide).to.be.equal(2);
    });
    ...
    it('should be possible to interact with clickable elements', async () => {
      ...
      const el = await fixture<MfCarousel>(html`
        <mf-carousel mouse-dragging>
          <mf-carousel-item><button>click me</button></mf-carousel-item>
          <mf-carousel-item>Node 2</mf-carousel-item>
          <mf-carousel-item>Node 3</mf-carousel-item>
        </mf-carousel>
      `);
      ...
      describe('and carousel is positioned on the last slide', () => {
        ...
        describe('and `loop` attribute is provided', () => {
          it('should scroll to the first slide', async () => {
            ...
            expect(el.activeMfide).to.be.equal(0);
          });
        });
      });
    });
  ...
  describe('API', () => {
    describe('#next', () => {
      it('should scroll the carousel to the next slide', async () => {
        ...
        `);
        sandbox.spy(el, 'goToMfide');
        const expectedCarouselItem: HTMLElement = el.querySelector('mf-carousel-item:nth-child(2)')!;
        ...
        // Assert
        expect(el.goToMfide).to.have.been.calledWith(1);
    ...
    describe('#previous', () => {
      it('should scroll the carousel to the previous slide', async () => {
        ...
        `);
        const expectedCarouselItem: HTMLElement = el.querySelector('mf-carousel-item:nth-child(1)')!;
        ...
        // Assert
        expect(el.goToMfide).to.have.been.calledWith(0);
        expect(itemRect.top).to.be.equal(containerRect.top);
        expect(itemRect.left).to.be.equal(containerRect.left);
      });
    });
  ...
  describe('Accessibility', () => {
    it('should pass accessibility tests', async () => {
      // Arrange
      const el = await fixture<MfCarousel>(html`
        <mf-carousel navigation pagination>
          <mf-carousel-item>Node 1</mf-carousel-item>
          <mf-carousel-item>Node 2</mf-carousel-item>
          <mf-carousel-item>Node 3</mf-carousel-item>
        </mf-carousel>
