 ...
 *
 * @event {{ entries: ResizeObserverEntry[] }} mf-resize - Emitted when the element is resized.
 */
export default class MfResizeObserver extends ShoelaceElement {
  ...
  connectedCallback() {
    ...
    this.resizeObserver = new ResizeObserver((entries: ResizeObserverEntry[]) => {
      this.emit('mf-resize', { detail: { entries } });
    });
