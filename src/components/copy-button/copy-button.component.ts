...
import MfTooltip from '../tooltip/tooltip.component.js';
 ...
 *
 * @dependency mf-icon
 * @dependency mf-tooltip
 *
 * @event mf-copy - Emitted when the data has been copied.
 * @event mf-error - Emitted when the data could not be copied.
 *
 * @slot copy-icon - The icon to show in the default copy state. Works best with `<mf-icon>`.
 * @slot success-icon - The icon to show when the content is copied. Works best with `<mf-icon>`.
 * @slot error-icon - The icon to show when a copy error occurs. Works best with `<mf-icon>`.
 *
 ...
 */
export default class MfCopyButton extends ShoelaceElement {
  ...
  @query('mf-tooltip') tooltip: MfTooltip;
      ...
      >
        ...
        >
          <slot part="copy-icon" name="copy-icon">
            <mf-icon library="system" name="copy"></mf-icon>
          </slot>
          <slot part="success-icon" name="success-icon" hidden>
            <mf-icon library="system" name="check"></mf-icon>
          </slot>
          <slot part="error-icon" name="error-icon" hidden>
            <mf-icon library="system" name="x-lg"></mf-icon>
          </slot>
        </button>
      </mf-tooltip>
    `;
