...
export default css`
  :host {
    --thumb-size: 20px;
    --tooltip-offset: 10px;
    --track-color-active: var(--mf-color-neutral-200);
    --track-color-inactive: var(--mf-color-neutral-200);
  ...
  .range__control {
    ...
    line-height: var(--mf-input-height-medium);
  ...
  .range__control::-webkit-slider-thumb {
    ...
    border: solid var(--mf-input-border-width) var(--mf-color-primary-600);
    -webkit-appearance: none;
  ...
  .range__tooltip {
    ...
    transition: var(--mf-transition-fast) opacity;
    pointer-events: none;
  }
  ...
  .range__tooltip:after {
    ...
    height: 0;
    left: 50%;
    translate: calc(-1 * var(--mf-tooltip-arrow-size));
  }
  ...
  .range--tooltip-top .range__tooltip:after {
    border-top: var(--mf-tooltip-arrow-size) solid var(--mf-tooltip-background-color);
    border-left: var(--mf-tooltip-arrow-size) solid transparent;
    border-right: var(--mf-tooltip-arrow-size) solid transparent;
    top: 100%;
  }
  ...
  .range--tooltip-bottom .range__tooltip:after {
    border-bottom: var(--mf-tooltip-arrow-size) solid var(--mf-tooltip-background-color);
    border-left: var(--mf-tooltip-arrow-size) solid transparent;
    border-right: var(--mf-tooltip-arrow-size) solid transparent;
    bottom: 100%;
  }
