 ...
 * @since 2.0
 *
 * @event mf-cancel - Emitted when the animation is canceled.
 * @event mf-finish - Emitted when the animation finishes.
 * @event mf-start - Emitted when the animation starts or restarts.
 *
 * @slot - The element to animate. Avoid slotting in more than one element, as subsequent ones will be ignored. To
 *  animate multiple elements, either wrap them in a single container or use multiple `<mf-animation>` elements.
 */
export default class MfAnimation extends ShoelaceElement {
