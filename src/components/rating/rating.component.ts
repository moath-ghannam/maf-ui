 ...
 * @dependency mf-icon
 *
 * @event mf-change - Emitted when the rating's value changes.
 * @event {{ phase: 'start' | 'move' | 'end', value: number }} mf-hover - Emitted when the user hovers over a value. The
 ...
 */
export default class MfRating extends ShoelaceElement {
   ...
   * well with `<mf-icon>` elements.
   */
  @property() getSymbol: (value: number) => string = () => '<mf-icon name="star-fill" library="system"></mf-icon>';
