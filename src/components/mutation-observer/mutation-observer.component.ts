 ...
 * @since 2.0
 *
 * @event {{ mutationList: MutationRecord[] }} mf-mutation - Emitted when a mutation occurs.
 *
 * @slot - The content to watch for mutations.
 */
export default class MfMutationObserver extends ShoelaceElement {
