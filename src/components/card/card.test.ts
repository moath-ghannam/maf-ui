...
import type MfCard from './card.js';
...
describe('<mf-card>', () => {
  ...
  describe('when provided no parameters', () => {
    before(async () => {
      el = await fixture<MfCard>(html`
        <mf-card>This is just a basic card. No image, no header, and no footer. Just your content.</mf-card>
      `);
    });
