...
import type MfProgressRing from './progress-ring.js';

describe('<mf-progress-ring>', () => {
  let el: MfProgressRing;

  describe('when provided just a value parameter', () => {
    before(async () => {
      el = await fixture<MfProgressRing>(html`<mf-progress-ring value="25"></mf-progress-ring>`);
    });
  ...
  describe('when provided a title, and value parameter', () => {
    ...
    before(async () => {
      el = await fixture<MfProgressRing>(
        html`<mf-progress-ring title="Titled Progress Ring" value="25"></mf-progress-ring>`
      );
  ...
  describe('when provided a ariaLabel, and value parameter', () => {
    before(async () => {
      el = await fixture<MfProgressRing>(
        html`<mf-progress-ring ariaLabel="Labelled Progress Ring" value="25"></mf-progress-ring>`
      );
    });
  ...
  describe('when provided a ariaLabelledBy, and value parameter', () => {
    before(async () => {
      el = await fixture<MfProgressRing>(html`
        <label id="labelledby">Progress Ring Label</label>
        <mf-progress-ring ariaLabelledBy="labelledby" value="25"></mf-progress-ring>
      `);
    });
