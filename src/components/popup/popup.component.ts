 ...
 * @since 2.0
 *
 * @event mf-reposition - Emitted when the popup is repositioned. This event can fire a lot, so avoid putting expensive
 ...
 *  attribute is used.
 * @cssproperty [--arrow-color=var(--mf-color-neutral-0)] - The color of the arrow.
 ...
 *  available when using `auto-size`.
 */
export default class MfPopup extends ShoelaceElement {
