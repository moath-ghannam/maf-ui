...
import type MfBreadcrumbItem from './breadcrumb-item.js';

describe('<mf-breadcrumb-item>', () => {
  let el: MfBreadcrumbItem;

  describe('when not provided a href attribute', () => {
    before(async () => {
      el = await fixture<MfBreadcrumbItem>(html` <mf-breadcrumb-item>Home</mf-breadcrumb-item> `);
    });
  ...
  describe('when provided a href attribute', () => {
    describe('and no target', () => {
      before(async () => {
        el = await fixture<MfBreadcrumbItem>(html`
          <mf-breadcrumb-item href="https://jsonplaceholder.typicode.com/">Home</mf-breadcrumb-item>
        `);
      });
    ...
    describe('and target, without rel', () => {
      before(async () => {
        el = await fixture<MfBreadcrumbItem>(html`
          <mf-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank">Help</mf-breadcrumb-item>
        `);
      });
    ...
    describe('and target, with rel', () => {
      before(async () => {
        el = await fixture<MfBreadcrumbItem>(html`
          <mf-breadcrumb-item href="https://jsonplaceholder.typicode.com/" target="_blank" rel="alternate"
            >Help</mf-breadcrumb-item
          >
        `);
      });
