  ...
  plugins: [
      ...
      analyzePhase({ ts, node, moduleDoc }) {
        switch (node.kind) {
          case ts.SyntaxKind.ClassDeclaration: {
            ...
            const tagName = 'mf-' + tagNameWithoutPrefix;
    ...
    customElementVsCodePlugin({
      ...
      referencesTemplate: (_, tag) => [
        {
          name: 'Documentation',
          url: `https://shoelace.style/components/${tag.replace('mf-', '')}`
        }
      ]
    }),
    ...
    customElementVuejsPlugin({
      ...
      fileName: 'index.d.ts',
      componentTypePath: (_, tag) => `../../components/${tag.replace('mf-', '')}/${tag.replace('mf-', '')}.component.js`
    })
  ]
};
