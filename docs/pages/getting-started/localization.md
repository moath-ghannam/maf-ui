...
- If you're using the CDN, [import them from the CDN](https://www.jsdelivr.com/package/npm/maf-ui-kit?path=%CDNDIR%%2Ftranslations)
- If you're using a bundler, import them from `maf-ui-kit/%NPMDIR%/translations/[lang].js`
...
```js
import { registerTranslation } from 'maf-ui-kit/dist/utilities/localize';
import type { Translation } from 'maf-ui-kit/dist/utilities/localize';
